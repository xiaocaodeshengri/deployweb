...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header layui-bg-gray">
        ...
        <div class="layui-nav layui-layout-right">
            <input class="layui-input" id="queryText" style="display: inline-block;width: 150px;height: 25px;" v-model='TextNode'
                   placeholder="输入文字标记" @change="addText">
            <i class="fa fa-pencil-square-o toolbar-icon" aria-hidden="true" title="编辑" v-show="getRole(2)"
            ...
            <i class="fa fa-floppy-o toolbar-icon" aria-hidden="true" title="保存" v-show="getRole(2)"
               onClick="editor.saveTopology(true)"></i>
            <i class="fa fa-clipboard toolbar-icon" aria-hidden="true" title="复制" v-show="getRole(2)"
               onClick="editor.utils.cloneSelectedNodes()"></i>
            <i class="fa fa-times toolbar-icon" aria-hidden="true" title="删除" v-show="getRole(2)"
               onClick="editor.utils.deleteSelectedNodes()"></i>
            <i class="fa fa-trash-o toolbar-icon" aria-hidden="true" title="清空" v-show="getRole(2)"
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md10">
                <div id="topology-body" class="topology-context">
                    ...
                    <canvas class="topology-context" id="topology-canvas" style="border:1px solid #c3c3c3;">
                        您的浏览器不支持HTML5!
                    </canvas>
                </div>
            </div>
...
<script>
    ...
    export default{
        ...
        methods: {
            initCanvas(){
                topoName = this.$route.params.topoName
            ...
            addText(){
                editor.utils.setText(this.TextNode);
                this.TextNode = '';
            }
        }
    }
    ...
    $(document).ready(function () {
        ...
        // 加载网络拓扑图
        editor.loadTopology('/api/topo/' + topoName, "static/jtopo/img/backimg.png");
    });
</script>